...
class RequirementScreenCard extends StatefulWidget {
  final Color background;
  final String title;

  const RequirementScreenCard({
    super.key,
  ...
  @override
  State<RequirementScreenCard> createState() => _RequirementScreenCardState();
}

class _RequirementScreenCardState extends State<RequirementScreenCard> {
    ...
    return Flexible(
      child: Container(
        ...
        child: Column(
          children: [
            Text(
              "(${ticketController.requirementList.value.ticketDetails!.length}) Requirements",
